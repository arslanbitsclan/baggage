@if (session()->has('admin'))
    ...
    @push('head')
        <title>Order Completion Template | Baggage Factory</title>
    ...
    @section('section')
        ...
        <section class="content-main">
            <form action="{{ route('Admin.order-completion-set') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <h2 class="content-title">Order Completion Template</h2>
                            <div>
