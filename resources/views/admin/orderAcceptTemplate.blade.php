@if (session()->has('admin'))
    ...
    @push('head')
        <title>Order Template | Baggage Factory</title>
    ...
    @section('section')
        ...
        <section class="content-main">
            <form action="{{ route('Admin.order-acceptence-set') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <h2 class="content-title">Order Acceptence Template</h2>
                            <div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea placeholder="Type here" class="form-control" rows="4" id="extra_content" name="extra_content">{{ $template->content }}</textarea>
                                </div>
