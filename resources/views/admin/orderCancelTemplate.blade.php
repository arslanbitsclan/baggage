@if (session()->has('admin'))
    ...
    @push('head')
        <title>Order Cancelation Template | Baggage Factory</title>
    ...
    @section('section')
        ...
        <section class="content-main">
            <form action="{{ route('Admin.order-cancelation-set') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <h2 class="content-title">Order Cancelation Template</h2>
                            <div>
