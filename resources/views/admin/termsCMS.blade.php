...
@push('head')
<title>Terms & Conditions CMS | Baggage Factory</title>
...
<section class="content-main">
    <div class="row">
        ...
        <div class="col-lg-8">
            <form action="{{ route('Admin.update-cms-content') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <textarea placeholder="Type here" class="form-control" rows="10" id="content"
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="show" name="show" onchange="show_ad({{ $content->id }})"
                            required>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="category" name="category" onchange="show_sub_category()">
                                <option value="" readonly hidden> Select Category </option>
                                @foreach ($categories as $category)
                                <option value="{{ $category->category_slug }}" @selected($category->
                                    category_slug==$content->category_slug)>{{ $category->category_title }}
                                </option>
                                @endforeach
                            </select>
                        </div>
