                                                ...
                                                <div class="single-comment justify-content-between d-flex">
                                                    <div class="user justify-content-between d-flex">
                                                        <div class="thumb text-center">
                                                            <h6><a href="javascript:void(0)">{{ $review->name }}</a>
                                                            </h6>
                                                        </div>
                                                        <div class="desc">
                                                            @for ($i = 0; $i < 5; $i++) @if ($i < floatval($review->
                                                                rating))
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="d-flex mb-30">
                                                <div class="d-inline-block mr-15">
                                                    @for ($i = 0; $i < 5; $i++) @if ($i < floatval($avg_of_rating))
                                                        <span class="fa fa-star text-warning"></span>
                                                        @else
                                                        <span class="fa fa-star"></span>
                                                        @endif
                                ...
                                <div class="row related-products">
                                    <div class="carausel-4-columns-cover position-relative">
                                        ...
                                        <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-1">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-12 col-sm-6 m-2 p-0">
                                                    ...
                                                    <div class="product-img-action-wrap">
                                                        <div class="product-img product-img-zoom">
                                                            <a
                                                                ...
                                                                @php
                                                                $image = explode(',',
                                                                $related_product->suppornting_media);
                                                                @endphp
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    ...
                                    <div class="product-detail-rating">
                                        ...
                                        <div class="product-rate-cover text-end">
                                            <div class="d-inline-block">
                                                @for ($i = 0; $i < 5; $i++) @if ($i < floatval($avg_of_rating)) <span
                                                    class="fa fa-star text-warning"></span>
                                                    @else
                                                    <span class="fa fa-star"></span>
                                                    @endif
