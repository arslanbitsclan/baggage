            ...
            <div class="row flex-row-reverse">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ url('/product-detail/' . $product->id) }}">
                                            ...
                                            <img class="hover-img" src="{{ asset('uploads/' . $image[0]) }}" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-badges product-badges-position product-badges-mrg"
                                        ...
                                        <span class="hot bg-dark">Hot</span>
                                    </div>
                                    @elseif ($badge == 'New')
                                    <div class="product-badges product-badges-position product-badges-mrg"
                                        style="margin-top: {{ $space }}%;">
                                        <span class="new bg-dark">New</span>
                                    </div>
                                    @elseif ($badge == 'Best Sell')
                                    <div class="product-badges product-badges-position product-badges-mrg"
                                        style="margin-top: {{ $space }}%;">
                                        <span class="best bg-dark">Best Sell</span>
                                    </div>
                                    @elseif ($badge == 'Featured')
                                    <div class="product-badges product-badges-position product-badges-mrg"
                                        style="margin-top: {{ $space }}%;">
                                        <span class="hot bg-dark">Featured</span>
                                    </div>
                                    @elseif ($badge == 'Sale')
                                    <div class="product-badges product-badges-position product-badges-mrg"
                                        style="margin-top: {{ $space }}%;">
                                        <span class="sale bg-dark">Sale</span>
                                    </div>
                                    @endif
                                    @php
                                    $space = $space + 13;
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="sidebar-widget price_range range mb-30">
                        ...
                        <a href="{{ url('/shop') }}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i>
                            Fillter</a>
                    </div>
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        @endphp
                        @foreach ($products as $product)
                        @if ($pro <= 3) <div class="single-post clearfix">
                            <div class="image">
                                <a href="{{ url('/product-detail/' . $product->id) }}">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    ...
                                    <div class="product-detail-rating">
                                        ...
                                        ->where('status', '=', 'Approved')
                                        ->first()->count;
                                        $avg_of_rating = \App\Models\Reviews::selectRaw('SUM(rating)/COUNT(products_id)
                                        as avg')
                                        ->where('products_id', '=', $product->id)
                                        ->where('status', '=', 'Approved')
                                        ->first()->avg;
                                        ...
                                        <div class="product-rate-cover text-end">
                                            <div class="d-inline-block">
                                                @for ($i = 0; $i < 5; $i++) @if ($i < $avg_of_rating) <span
